...
# 2022-08-20 15:01
花了几天的时间，折腾好了 [md-wiki](https://github.com/Kinneyzhang/md-wiki) 的核心功能。可以根据本地知识体系结构，很方便的编辑和发布到hugo博客。目前的功能已经完全够用，我努力克制自己不要陷入到工具的折腾中，当务之急是用起来：把自己学到的任何知识总结和个人思考纳入到这个体系中去；然后在使用的过程中，发现这个工具可以更完善的地方并记录下来。在我计划要完善它的时间去完善它。
